...
public class RecipeExtendedDTO {
    ...
    private List<IngredientExtendedDTO> ingredients;

    public RecipeExtendedDTO() {
    }

    public RecipeExtendedDTO(RecipeDB recipeDB) {
        if (recipeDB == null) {
            return;
        }
    ...
    public List<IngredientExtendedDTO> getIngredients() {
        return ingredients;
    }

    public void setIngredients(List<IngredientExtendedDTO> ingredients) {
        this.ingredients = ingredients;
    }

    public void addIngredient(IngredientExtendedDTO ingredient) {
